    ...
    $(".beer-btn").click(function (event) {
        ...
        $.ajax({
            ...
            for (var i = 0; i < response.records.length; i++) {
                ...
                var learnMoreLink = $("<button>Learn More</button>");
                var currentResponse = response.records[i];
                
                // learnMoreLink.click(function(event, currentResponse) {
                //     event.preventDefault();
                ...
                //         // // TODO: p tag and "Learn More" href
                        ...
                        beerDescription.text("Description: " + response.records[i].fields.descript);
